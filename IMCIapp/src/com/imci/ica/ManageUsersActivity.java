...
public class ManageUsersActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleCursorAdapter adapter =
            new SimpleCursorAdapter(this, android.R.layout.simple_list_item_1, usersCursor, from, to);
        listCurrentCenterUsers.setAdapter(adapter);
        
        //Make the button work...
        ((Button)findViewById(R.id.button_adduser)).setOnClickListener(new OnClickListener() {
        ...
        ((ListView)findViewById(R.id.listView_currentcenterusers)).setOnItemClickListener(new OnItemClickListener() {
